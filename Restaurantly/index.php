        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3  name="index-footer1">Content Changer</h3>
              <p  name="index-footerStreet">
              1616 René-Lévesque Blvd W<br>   </p>
              <p name="index-footerAddress"> 
              Montreal, Quebec H3H 1P8<br><br>   </p>
              <p name="index-footerPhone"> <strong>Phone:</strong> +1 5589 55488 55<br>   </p>
              <p name="index-footerEmail"><strong>Email:</strong> info@example.com<br>   </p>
