    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        Services provided by the restaurant with their price, a picture and a small description.</div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" class="table table-striped">
                            ...
                            <?php if ($_SESSION['loggedInUser']['level'] == "1") : ?>
                                <?php foreach ($_SESSION['all_slider'] as $slider) : ?>
                                    <tr>
                                        <td><?php echo $slider['title'] ?></td>
                                        <td><?php echo $slider['price'] ?></td>
                                        <td><?php echo $slider['picture'] ?></td>
