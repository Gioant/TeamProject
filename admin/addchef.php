...
<div class="content-wrapper" style="margin-top: 35px;">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h4 class="card-header">Add Chef Details</h4>
                    <!-- Account -->
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <!-- Show Picture -->
                            <img src="../Restaurantly/assets/img/chefs/default_pic.png" alt="user-avatar" class="d-block rounded" id="uploadedAvatar" width="100" height="100">
                            <div class="button-wrapper">
                                ...
                                <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                                    ...
                                    <input type="file" id="upload" class="account-file-input" accept="image/png, image/jpeg" hidden="" name="addChefPic"
                    ...
                    <div class="card-body">
                            ...
                            <div class="mt-2">
                                <button type="submit" class="btn btn-primary me-2" name="new_chef">Save changes</button>
