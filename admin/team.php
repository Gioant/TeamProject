    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        Employees name and lastname with their picture, their position and a small bio.</div>
                </div>
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" class="table table-striped">
                            ...
                            <?php if ($_SESSION['loggedInUser']['level'] == "1") : ?>
                                <?php foreach ($_SESSION['all_chefs'] as $chef) : ?>
                                    <tr>
                                        <td><?php echo $chef['name'] ?></td>
                                        <td><?php echo $chef['lastname'] ?></td>
                                        <td><?php echo $chef['avatar'] ?></td>
                                        <td><?php echo $chef['poste'] ?></td>
                                        <td><?php echo $chef['description'] ?></td>
                                        <td>
                                            <a href="editchef.php?updateID=<?= $chef['id'] ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                            <a href="team.php?chefDeleteID=<?= $chef['id'] ?>" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
