    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h1 class="mt-4">Portfolio Table</h1>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        Menu items with their description, price, picture and their type.</div>
                </div>
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        Portfolio DataTable
                        <div class="float-end">
                            <button type="button" class="btn btn-info"></i><a href="addportfolio.php" style="text-decoration: none;">+Add New</a>
                            </button>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="datatablesSimple" class="table table-striped">
                            ...
                            <?php if ($_SESSION['loggedInUser']['level'] == "1") : ?>
                                <?php foreach ($_SESSION['all_menu'] as $menu) : ?>
                                    <tr>
                                        <td><?php echo $menu['name'] ?></td>
                                        <td><?php echo $menu['description'] ?></td>
                                        <td><?php echo $menu['price'] ?></td>
                                        <td><?php echo $menu['picture'] ?></td>
